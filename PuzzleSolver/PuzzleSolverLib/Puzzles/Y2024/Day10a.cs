...
public class Day10a : PuzzleBaseClass
{
    ...
    public List<(int x, int y, int score)> TrailScore = new();
    ...
    public void TrailBlazer(int x, int y)
    {
        ...
        TrailScore.Add((x, y, pathConclusion.Count));
    ...
    public override string? OnSolve(ReadOnlySpan<char> inputFile)
    {
        ...
        return TrailScore.Sum(x => x.score).ToString();

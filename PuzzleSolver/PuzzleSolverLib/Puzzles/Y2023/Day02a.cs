...
namespace PuzzleSolverLib.Puzzles.Y2023
{
    ...
    public partial class Day02a : PuzzleBaseClass
    {
        ...
        public override string Description => @"As you walk, the Elf shows you a small bag and some cubes which are either red, green, or blue. Each time you play this game, 
        ...
        public override string? OnSolve(ReadOnlySpan<char> inputFile)
        {
            try
            {
                ...
                while (!sr.EndOfStream)
                {
                    ...
                    Log.WriteInfo($"INCLUDE IN SUM: {line}");
                    continue;
